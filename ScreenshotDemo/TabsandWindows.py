...
driver.get_screenshot_as_file(location+"/test3.png")
#driver.switch_to.alert.dismiss()
sleep(3)
contact_link = Keys.CONTROL+Keys.ENTER
contact_click=driver.find_element(By.XPATH,"//a[text()='Contact']").send_keys(contact_link)
sleep(3)

#switch to new tab and opens to new tab and focus on new tab
...
for wid in windowIDs:
    ...
    if driver.title == 'Contact - Dummy ticket':
        driver.close()

driver.switch_to.new_window("window")
driver.get("https://developer.mozilla.org/en-US/docs/Web/API/Element/mouseover_event")
